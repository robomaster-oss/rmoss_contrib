...
int SimpleAutoAimAlgo::init(std::vector<double> camera_intrinsic, std::vector<double> camera_distortion)
{
   //初始化工具类
...
{
   armor_detector_.setTargetColor(is_red);
}
